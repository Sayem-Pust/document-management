...
class DocumentVersion(models.Model):
    owner = models.ForeignKey(User, on_delete=models.CASCADE, related_name='owned_conversion', null=True, blank=True)
    file = models.FileField(upload_to='documents/')
    converted_file = models.FileField(upload_to='converted_documents/', blank=True, null=True)
